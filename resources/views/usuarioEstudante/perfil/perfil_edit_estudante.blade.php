    ...
    <main class="perfil" id="conteudo">
            ...
            <form action="{{ route('perfil_edit_store_estudante', $usuario->id_usuario) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="cadastro-container" style="display: flex;">
                            ...
                            @if($usuario->foto)
                                <div style="width: 50%; display: flex; flex-direction: column;">
                                    <div class="img-foto-perfil">
                                        <img id="current-image" onclick="openFileSelector()" class="foto-perfil" src="{{ url('storage/' . Auth::user()->foto) }}" alt="imagem de perfil do usuario">
                        ...
                        <div class="caixa-input" style="width: 50%;">
                            ...
                            @error('password')
                                <div style="position: relative;">
                                    <input title="{{ $message }}" class="alert-danger" type="password" id="password" name="password" placeholder="Digite aqui a nova senha" style="border: 1px solid red; background-color:rgb(235, 201, 206); color: black">
                                    <label for="password">
                    ...
                    <div class="caixa-input" style="width: 50%;">
                        @error('ra')
                            <input title="{{ $message }}" class="alert-danger" type="number" id="ra" name="ra" autocomplete="off" value="{{ $usuarioEstudante->ra }}"  style="border: 1px solid red; background-color:rgb(235, 201, 206); color: black" required>
                            <label for="ra">
                                <span>Número de matrícula</span>
                            </label>
                        @else
                            <input type="number" id="ra" name="ra" autocomplete="off" value="{{ $usuarioEstudante->ra }}" required>
                            <label for="nome">
                                <span>Número de matrícula</span>
                            </label>
                        @enderror
