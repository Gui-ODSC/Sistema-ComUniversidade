...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/usuarioProfessor/cadastro/cadastro_professor.css') }}">
...
<body>
    ...
    <div class="cadastro-container">
        ...
        <form method="POST" action="{{ route('cadastro_create_professor') }}" enctype="multipart/form-data">
            ...
            <div style="margin: 3px 10px; display: flex; flex-wrap: wrap">
                ...
                <div class="caixa-input" style="width: 490px; margin-left: 3px">
                    {{-- INSTITUICAO --}}
                    @error('instituicao')
                ...
                <div class="caixa-input" style="width: 50%;">
                    ...
                    @error('link_curriculo')
                        <input title="{{ $message }}" class="alert-danger" autocompĺete="off" type="text" id="link_curriculo" name="link_curriculo" value="{{ old('link_curriculo') }}" style="border: 1px solid red; background-color: rgb(235, 201, 206); color: black">
                        <label for="link_curriculo">
                            <span>Link Curriculo</span>
                        </label>
                    @else
                        <input type="text" id="link_curriculo" name="link_curriculo" autocompĺete="off" value="{{ old('link_curriculo') }}">
                        <label for="link_curriculo">
                            <span>Link Curriculo</span>
                        </label>
                    @enderror
                ...
                <div class="caixa-input" style="width: 490px; margin-left: 3px">
                    ...
                    @error('numero_registro')
                        <input title="{{ $message }}" class="alert-danger" autocompĺete="off" type="text" id="numero_registro" name="numero_registro" value="{{old('numero_registro')}}" style="border: 1px solid red; background-color:rgb(235, 201, 206); color: black" required>
                        <label for="numero_registro">
                            <span>Número Registro (somente números)</span>
                        </label>
                    @else
                        <input type="text" id="numero_registro" name="numero_registro" autocompĺete="off" value="{{old('numero_registro')}}" required>
                        <label for="numero_registro">
                            <span>Número Registro (somente números)</span>
                        </label>
                    @enderror
    ...
    <script>
        ...
        document.getElementById('numero_registro').addEventListener('input', function(event) {
