        ...
        <form method="POST" action="{{ route('cadastro_create_professor') }}" enctype="multipart/form-data">
            ...
            <div style="display: flex; margin: 5px 10px;">
                <div style="display: flex; flex-direction: column; position: relative;">
                    ...
                    <button id="remove-image" onclick="removeImage()" style="display: none; position: absolute; top: 10px; right: 10px; color: black; border: 1px solid black; border-radius: 5px; width: 30px; font-size: 10px; height: 30px">X</button>
                </div>
            ...
            <div style="margin: 3px 10px; display: flex; flex-wrap: wrap">
                ...
                <div class="caixa-input readonly" style="width: 50%; opacity: 0.7; margin-bottom: 6px">
                    {{-- CIDADE --}}
                    @error('cidade')
                ...
                <div class="caixa-input" style="width: 50%;">
                    ...
                    @error('link_curriculo')
                        <input title="{{ $message }}" class="alert-danger" autocompĺete="off" type="text" id="link_curriculo" name="link_curriculo" value="{{ old('link_curriculo') }}" style="border: 1px solid red; background-color: rgb(235, 201, 206); color: black" maxlength="100">
                        <label for="link_curriculo">
                            <span>Link Curriculo</span>
                        </label>
                    @else
                        <input type="text" id="link_curriculo" name="link_curriculo" autocompĺete="off" value="{{ old('link_curriculo') }}" maxlength="100">
                        <label for="link_curriculo">
                            <span>Link Curriculo</span>
                        </label>
                    @enderror
                ...
                <div class="caixa-input" style="width: 490px; padding-left: 3px">
                    ...
                    @else
                        <input type="number" id="numero_registro" name="numero_registro" autocompĺete="off" value="{{old('numero_registro')}}" required maxlength="30">
                        <label for="numero_registro">
                            <span>Número Registro (somente números) *</span>
                        </label>
                    @enderror
