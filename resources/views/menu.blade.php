...
<nav class="menu-navegacao" id="menu_navegacao">
    ...
    <a href="{{ route('todas_ofertas') }}"><i><img src="{{ asset('img/icones/menu/setas.png') }}" id="icones-menu" alt="icone de oferta/demanda"></i>Todas as Ofertas</a>
    <a href="{{ route('todos_contatos_realizados') }}"><i><img src="{{ asset('img/icones/menu/contato.png') }}" id="icones-menu" alt="icone de contato"></i>Contatos Realizados</a>
    <a href="{{ route('todos_contatos_recebidos') }}"><i><img src="{{ asset('img/icones/menu/contato.png') }}" id="icones-menu" alt="icone de contato"></i>Contatos Recebidos</a>
