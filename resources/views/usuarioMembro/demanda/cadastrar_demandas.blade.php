...
<body>
    ...
    <main class="cadastrar_demandas" id="conteudo">
        ...
        <form action="{{ route('demanda_create_store') }}" method="POST">
            ...
            @else
                <div class="autoComplete_wrapper">
                    <input type="text" id="autoCompletePublicoAlvo" name="publico_alvo" placeholder="Publico Alvo da Ação" autocomplete="off" required>
                </div>
            @enderror
            ...
            @else
                <div class="autoComplete_wrapper">
                    <input type="text" id="autoCompleteAreaConhecimento" name="area_conhecimento" placeholder="Área de Conhecimento" autocomplete="off" required>
                </div>
            @enderror
            @error('descricao')
            ...
            @else
                <textarea type="text" name="descricao" placeholder="Texto Livre" required></textarea>
            @enderror
            ...
            @else
                <input type="number" name="pessoas_afetadas" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Numero Aproximado de Pessoas Impactadas" required>
            @enderror
            @error('duracao')
            ...
            @else
                <input type="text" name="instituicao_setor" placeholder="Setor/Instituição">
            @enderror
