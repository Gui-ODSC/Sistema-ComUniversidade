...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/usuarioMembro/matching_demandas/modal_contatar/modal_contatar_oferta.css') }}">
    ...
    <div class="clicar-fora-modal-contatar" id="clicar-fora-modal-contatar" onclick="closeModalContatarOferta()"></div>
        <div class="modal-contatar" id="modal-contatar">
            ...
            <div class="mensagem-contato">
                <form id="form-contato" action="{{ route('visualizar_matching_demandas_membro') }}" onsubmit="return validarEnviarFormulario()">
