...
<body>
    <!-- MODAL -->
    <div class="clicar-fora-contato-respondido" id="clicar-fora-contato-respondido" onclick="closeModalContatoRespondido()"></div>
        <div class="modal-contato-respondido" id="modal-contato-respondido">
            ...
            <div class='resposta-realizada'>
                <h6>Sua Resposta:</h6>
                <p><strong>Que pena, no momento sua ajuda não será bem vinda, pelo que vi parece que voce não possui as habilidades que eu preciso, obrigado mesmo assim...</strong>
                <br><br><br>Independentemente do conteúdo apresentado acima, o sistema entende que o contato incial já foi realizado entre as partes interessadas, portanto qualquer próxima forma de contato deve seguir por meio de outro meio de contato (email, telefone ....)</p>
            </div>
            <div class="botoes-oferta-respondido">
                <div>
                    <span onclick="confirmarResposta()" id="botao-fechar-contato-respondido"><button>Fechar</button></span>
                </div>
            </div>
        </div>
